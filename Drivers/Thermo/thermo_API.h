...
void t_init(API_THERMO_STRUCT *t_struct, uint8_t id);                                                         ///< Pointer to \ref ARM_SPI_Initialize : Initialize SPI Interface.                                                       ///< Pointer to \ref ARM_SPI_Uninitialize : De-initialize SPI Interface.
